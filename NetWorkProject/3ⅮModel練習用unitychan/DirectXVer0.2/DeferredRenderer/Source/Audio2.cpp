...
{
	{"Assets/MP3/ES_Something Good - Velveteen (online-audio-converter.com).wav", true}			// サンプルBGM（ループさせるのでtrue設定）
	//{"assets/se/laser0.wav", false},		// サンプルSE（ループしないのでfalse設定）
	//{"assets/se/bomb0.wav", false},			// サンプルSE
};
