...
// Rasterize D3D11_CULL_NONE &  CCW TRUE
//---------------------------------------------
#include "DirectX11Manager.h"

DirectX11Manager g_DX11Manager;

//フォント用にglobal領域に格上げ 2021-03-22
...
#pragma region HardWare Check
	...
	auto hr = CreateDXGIFactory(__uuidof(IDXGIFactory),
		(void**)& factory);
	if (FAILED(hr))
	{
		return hr;
	...
	hr = factory->EnumAdapters(GPUNumber, &g_Adapter);
	if (FAILED(hr))
	{
		return hr;
	}
...
#pragma region DirectX11Init
	...
	hr = D3D11CreateDeviceAndSwapChain(g_Adapter, D3D_DRIVER_TYPE_UNKNOWN, NULL,
...
void DirectX11Manager::DrawBegin()
{
	...
	m_pImContext->ClearDepthStencilView(m_pDepthStencilView.Get(),
